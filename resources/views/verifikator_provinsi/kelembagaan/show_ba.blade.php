...
<head>
    ...
    <title>Kelembagaan {{$district->name}}_Tahun 2023-2024</title>
    <style>
        body {
...
<body onload="print()">
    <h1>
        Kelembagaan {{$district->name}} <br> Tahun 2023-2024
    </h1>
    ...
    <table width="100%" border="0" style="margin-top: 50px">
        <tr>
            ...
            <td width="50%" align="center"><div>Perwakilan Kab/Kota</div>
                <div style="text-align:center;">{{$ba->jb_pj_kabkota ?? ''}}</div>
                <p align="center">&nbsp;</p>
            </td>
        </tr>
        <tr>
            <td align="center">
                <div style="text-align:center;">
                    <div><strong><u>{{$ba->tim_verifikasi ?? '-'}}</u></strong></div>
                     <div style="padding-left:1px;"> <?php //echo $data->row()->jabatan_opd;?></div> 
                </div>
            </td>
            <td align="center">
                <div>
                    <div><strong><u> {{$ba->nama_pj_kabkota ?? '-'}}</u></strong></div>
