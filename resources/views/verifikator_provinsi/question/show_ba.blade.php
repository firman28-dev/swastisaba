    ...
    <table width="100%" border="0" style="margin-top: 50px">
        <tr>
            ...
            <td width="50%" align="center"><div>Perwakilan Kab/Kota</div>
                <div style="text-align:center;">{{$ba_pertatanan->jb_pj_kabkota ?? ''}}</div>
                <p align="center">&nbsp;</p>
            </td>
        </tr>
        <tr>
            <td align="center">
                <div style="text-align:center;">
                    <div><strong><u>{{$ba_pertatanan->tim_verifikasi ?? ''}}</u></strong></div>
                     <div style="padding-left:1px;"> <?php //echo $data->row()->jabatan_opd;?></div> 
                </div>
            </td>
            <td align="center">
                <div>
                    <div><strong><u> {{$ba_pertatanan->nama_pj_kabkota ?? ''}}</u></strong></div>
