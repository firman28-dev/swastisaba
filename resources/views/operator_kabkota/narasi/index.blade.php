                ...
                <table id="tableSKPD" class="table table-striped table-row-bordered gy-5 gs-7 border rounded" style="width:100%">
                    <thead>
                        <tr class="fw-semibold fs-6 text-muted">
                            ...
                            <th class="border border-1 text-center">Dokumen Narasi</th>
                    ...
                    <tbody>
                        @foreach ($category as $data)
                            <tr>
                                ...
                                @php
                                    $relatedAnswerDoc = $answer_narasi->where('id_category', $data->id)->first();
                                @endphp
                                @if ($relatedAnswerDoc)
                                    ...
                                    <td class="border border-1 text-center">
                                        <a href="{{ asset('uploads/doc_narasi/'.$relatedAnswerDoc->path) }}" target="_blank" class="btn btn-icon btn-success w-35px h-35px mb-sm-0 mb-3">
                                        ...
                                        <div class="modal fade text-start" tabindex="-1" id="confirmDelete{{ $relatedAnswerDoc->id }}">
                                            <form action="{{ route('narasi-tatanan.destroy', $relatedAnswerDoc->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group w-100">
                                                                ...
                                                                <p class="text-danger">Dokumen berbentuk Pdf dan maksimal 4 MB</p>
