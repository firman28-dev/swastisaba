...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{ route('g-data.updateKabKota',$generalData->id) }}" method="POST">
            @csrf
            @method('put')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                oninput="this.setCustomValidity('')"
                                value="{{$generalData->nama_wako_bup}}"
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                oninput="this.setCustomValidity('')"
                                value="{{$generalData->nama_pembina}}"
                            >
                            @error('nama_pembina')
                                <div class="is-invalid">
                                    <span class="text-danger">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group">
                            ...
                            <textarea name="alamat_kantor_forum" id="alamat_kantor_forum" class="form-control form-control-solid rounded rounded-4" rows="2" >{{$generalData->alamat_kantor_forum}}</textarea>
