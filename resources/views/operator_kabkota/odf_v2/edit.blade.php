...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{ route('data-odf.update',$transOdf->id) }}" method="POST">
            @method('put')
            @csrf
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                min="0"
                                max="100"
                                value="{{$transOdf->sum_subdistricts}}"
                                readonly
                            >
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                oninvalid="this.setCustomValidity('Nilai harus di bawah atau sama dengan {{ $transOdf->sum_villages }}')"
                                name="s_villages_stop_babs"
                                value="{{$transOdf->s_villages_stop_babs}}"
                                max="{{$transOdf->sum_villages}}"
                            >
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                readonly
                                value="{{$transOdf->p_villages_stop_babs}}"
                            >
...
@section('script')
    <script>
        const sum_villages = {{$transOdf->sum_villages}};
