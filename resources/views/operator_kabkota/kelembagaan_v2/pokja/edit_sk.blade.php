...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{route('pokja-desa.updateSKPokjaDesa', $activity->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card-header">
                <h3 class="card-title">Edit SK Pokja Desa</h3>
            </div>
            ...
            <div class="card-footer">
                ...
                &nbsp;
                <a href="{{route('pokja-desa.showPokjaDesa',[$activity->id_c_kelembagaan, $village->subdistrict_id])}}" class="btn btn-sm btn-secondary">
                    Kembali
                </a>
            </div>
