...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{route('pokja-desa.updateActivityPokjaDesa', $activity->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card-header">
                <h3 class="card-title">Edit Kegiatan Pokja Desa</h3>
            </div>
