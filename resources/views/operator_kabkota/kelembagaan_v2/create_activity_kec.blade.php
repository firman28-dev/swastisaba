...
@section('heading')
Kegiatan Forum Kecamatan
@endsection
@section('page')
    Data Kegiatan Forum Kecamatan
@endsection
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{route('act-kec.storeActivityKec', $category->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-header">
                <h3 class="card-title">Input Kegiatan Forum Kecamatan</h3>
            </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group w-100">
                            ...
                            <input type="text"
                                ...
                                readonly
                            >
                            <input name="id_kode" id="id_kode" value="{{$subdistrict->id}}" hidden>
                            @error('id_kode')
