        ...
        <form action="{{ route('kelembagaan-v2.updateForumKec' , $activity->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group w-100">
                            <label for="path_budget" class="form-label">Dokumen Anggaran Forum Kec<span class="text-danger"> * pdf | Max 4 MB</span> </label>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group w-100">
                            <label for="path_sk_f" class="form-label">Dokumen SK Forum Kec<span class="text-danger"> * pdf | Max 4 MB</span> </label>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group w-100">
                            <label for="path_plan_f" class="form-label">Dokumen Renja Forum Kec<span class="text-danger"> * pdf | Max 4 MB</span> </label>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group w-100">
                            <label for="path_s" class="form-label">Foto Sekretariat Forum Kec<span class="text-danger"> * pdf | Max 4 MB</span> </label>
