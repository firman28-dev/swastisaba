...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body">
            <a href="{{ route('v-pusat.indexKelembagaan', $zona->id)}}">
                        ...
                        <tr>
                            ...
                            {{-- <td class="border border-1">
                                ...
                                <div class="modal fade" tabindex="-1" id="confirmUpdate{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false">
                                    <form action="{{ route('v-pusat.storeKelembagaan', ['id_zona' => $zona->id, 'id' => $item->id])}}" method="POST">
                                        @csrf
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionAda" value="1" {{ isset($relatedAnswer) && $relatedAnswer->answer_pusat == 1 ? 'checked' : '' }} required>
                                                        <label class="form-check-label" for="optionAda">Ada</label>
                                                    </div>
                                            
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionTidakAda" value="2" {{ isset($relatedAnswer) && $relatedAnswer->answer_pusat == 2 ? 'checked' : '' }} required>
                                                    ...
                                                    <div class="row mb-3 mt-3">
                                                        <div class="col-12">
                                                            <div class="form-group w-100">
                                                                ...
                                                                @if (!empty($relatedAnswer->comment_pusat))
                                                                    <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar">{{$relatedAnswer->comment_pusat}}</textarea>
                                                                @else
                                        ...
                                        <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                                            ...
                                                                            <td class="border border-1">
                                                                                <div class="form-check">
                                                                                    <input 
                                                                                        ...
                                                                                        value="{{ $opsi->id }}" 
                                                                                        @if($relatedAnswer->id_opt_kelembagaan_pusat == $opsi->id) checked @endif
                                                    ...
                                                    <div class="row mb-3 mt-3">
                                                        <div class="col-12">
                                                            <div class="form-group w-100">
                                                                <label for="comment_pusat" class="form-label bold">Komentar</label>
                                                                @if (!empty($relatedAnswer->comment_pusat))
                                                                    <textarea name="comment_pusat" id="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar">{{$relatedAnswer->comment_pusat}}</textarea>
                                                                @else
                                                                    <textarea name="comment_pusat" id="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar"></textarea>
                                                                @endif
                                    ...
                                    <div class="modal fade text-start" tabindex="-1" id="confirmSKPokja{{ $forum2->id }}" data-bs-backdrop="static" data-bs-keyboard="false">
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('v-pusat.storeSKKec', $forum2->id)}}" method="POST">
                                                    {{-- <form action="{{ route('v-pusat.storeKelembagaan', $item->id)}}" method="POST"> --}}
                                                    @csrf
                                                    <p><strong>{{$forum2->f_district}}</strong></p>
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionAda_{{$forum2->id}}" {{ $forum2->answer_pusat == 1 ? 'checked' : '' }} value="1" required>
                                                        <label class="form-check-label" for="optionAda_{{$forum2->id}}">Sesuai</label>
                                                    </div>
                                            
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionTidakAda_{{$forum2->id}}" {{ $forum2->answer_pusat == 2 ? 'checked' : '' }} value="2"  required>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <div class="form-group w-100">
                                                                ...
                                                                @if (!empty($forum2->comment_pusat))
                                                                    <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar" required>{{$forum2->comment_pusat}}</textarea>
                                                                @else
                                            ...
                                            <div class="modal fade text-start" tabindex="-1" id="confirmEditVPusat2{{ $item_v2->id }}" data-bs-backdrop="static" data-bs-keyboard="false">
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('v-pusat.storeActivity', $item_v2->id)}}" method="POST">
                                                            {{-- <form action="{{ route('v-pusat.storeKelembagaan', $item->id)}}" method="POST"> --}}
                                                            @csrf
                                                            <p><strong>{{$item_v2->name}}</strong></p>
                                                            <div class="form-check mb-3">
                                                                <input class="form-check-input" type="radio" name="answer_pusat" id="optionAda_{{$item_v2->id}}" value="1" {{ $item_v2->answer_pusat == 1 ? 'checked' : '' }} required>
                                                                <label class="form-check-label" for="optionAda_{{$item_v2->id}}">Sesuai</label>
                                                            </div>
                                                    
                                                            <div class="form-check mb-3">
                                                                <input class="form-check-input" type="radio" name="answer_pusat" id="optionTidakAda_{{$item_v2->id}}" value="2" {{ $item_v2->answer_pusat == 2 ? 'checked' : '' }} required>
                                                            ...
                                                            <div class="row mb-3">
                                                                <div class="col-12">
                                                                    <div class="form-group w-100">
                                                                        <label class="form-label bold">Komentar</label>
                                                                        @if (!empty($item_v2->comment_pusat))
                                                                            <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar" required>{{$item_v2->comment_pusat}}</textarea>
                                                                        @else
                                                                            <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar" required></textarea>
                                                                        @endif
                    ...
                    <tbody>
                       @foreach ($subdistrict as $item)
                           <tr>
                                ...
                                <td class="border-1 border">{{$item->name}}</td>
                                <td class="border-1 border">
                                    <a href="{{route('v-pusat.showPokjaDesa',[$category->id, $item->id])}}" class="btn btn-outline btn-outline-success btn-sm">
                                        Lihat detailnya
                                    </a>
                                </td>
                           </tr>
                                    ...
                                    <div class="modal fade text-start" tabindex="-1" id="confirmEditVPusat{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false">
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('v-pusat.storeActivity', $item->id)}}" method="POST">
                                                    {{-- <form action="{{ route('v-pusat.storeKelembagaan', $item->id)}}" method="POST"> --}}
                                                    @csrf
                                                    <p><strong>{{$item->name}}</strong></p>
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionAda_{{$item->id}}" value="1" {{ $item->answer_pusat == 1 ? 'checked' : '' }} required>
                                                        <label class="form-check-label" for="optionAda_{{$item->id}}">Sesuai</label>
                                                    </div>
                                            
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionTidakAda_{{$item->id}}" value="2" {{ $item->answer_pusat == 2 ? 'checked' : '' }} required>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <div class="form-group w-100">
                                                                <label class="form-label bold">Komentar</label>
                                                                @if (!empty($item->comment_pusat))
                                                                    <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar">{{$item->comment_pusat}}</textarea>
                                                                @else
                                                                    <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar"></textarea>
                                                                @endif
