...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            <a href="{{route('v-pusat.showKelembagaan',['id_zona' => $subdistrict->district_id, 'id' => $category->id])}}" class="btn-outline-primary btn-outline btn mb-4 btn-sm">
                Kembali
            </a>
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('v-pusat.storeSKPokja', $forumKel2->id)}}" method="POST">
                                                    {{-- <form action="{{ route('v-pusat.storeKelembagaan', $item->id)}}" method="POST"> --}}
                                                    @csrf
                                                    <p><strong>{{$forumKel2->f_village}}</strong></p>
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionAda_{{$forumKel2->id}}" {{ $forumKel2->answer_pusat == 1 ? 'checked' : '' }} value="1" required>
                                                        <label class="form-check-label" for="optionAda_{{$forumKel2->id}}">Sesuai</label>
                                                    </div>
                                            
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" type="radio" name="answer_pusat" id="optionTidakAda_{{$forumKel2->id}}" {{ $forumKel2->answer_pusat == 2 ? 'checked' : '' }} value="2"  required>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <div class="form-group w-100">
                                                                ...
                                                                @if (!empty($forumKel2->comment_pusat))
                                                                    <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar" required>{{$forumKel2->comment_pusat}}</textarea>
                                                                @else
