                        ...
                        <tr>
                            ...
                            <td class="text-center p-3 border border-1">
                                ...
                                <div class="modal fade" tabindex="-1" id="confirmUpdate{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false">
                                    <form action="{{ route('v-pusat.storeGdata', ['id_zona' => $zona->id, 'id' => $item->id])}}" method="POST">
                                        @csrf
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group w-100">
                                                                ...
                                                                @if (!empty($answerDoc->comment_pusat))
                                                                    <textarea name="comment_pusat" class="form-control form-control-solid rounded rounded-4" cols="3" rows="2" placeholder="Komentar">{{$answerDoc->comment_pusat}}</textarea>
                                                                @else
