...
@section('content')
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        <div class="card-header cursor-pointer">
            ...
            <a href="" class="btn btn-primary btn-sm align-self-center">Edit Data</a>
        </div>
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                <label class="col-lg-3 fw-semibold text-muted">Alamat Kantor</label>
                <div class="col-lg-9 fv-row">
                    <span class="fw-semibold text-gray-800 fs-6" id="phoneUser">{{$g_data->alamat_kantor ?? 'Belum ada'}}</span>
                </div>
            </div>
            <div class="row mb-7">
