                    ...
                    <tbody>
                        @foreach ($trashedData as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('group.restore', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('group.forceDelete', $data->id) }}">
                                            @csrf
                                            @method('delete')
