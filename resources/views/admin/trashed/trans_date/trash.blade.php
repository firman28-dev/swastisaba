                ...
                <table id="tableTrash" class="table table-striped table-row-bordered border rounded" style="width:100%">
                    <thead>
                        <tr class="fw-semibold fs-6 text-muted">
                            ...
                            <th class="border border-1 p-3">Tahun</th>
                        ...
                        @foreach ($trashedData as $data)
                            <tr>
                                ...
                                <td class="border border-1 text-center">
                                    <a href="{{ route('trans-date.restore', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('trans-date.forceDelete', $data->id) }}">
                                            @csrf
                                            @method('delete')
