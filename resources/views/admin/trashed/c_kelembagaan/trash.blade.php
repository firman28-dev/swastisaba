    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header justify-content-between">
            <div class="card-title">
                <h3>
                    Daftar Sampah Kategori Kelembagaan
                </h3>
                    ...
                    <tbody>
                        @foreach ($trashedData as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('c-kelembagaan.restore', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('c-kelembagaan.forceDelete', $data->id) }}">
                                            @csrf
                                            @method('delete')
