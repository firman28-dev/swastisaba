    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header justify-content-between">
            <div class="card-title">
                <h3>
                    Daftar Sampah  Data Pendukung Pertanyaan
                </h3>
                ...
                <table id="tableTrash" class="table table-striped table-row-bordered border rounded" style="width:100%">
                    <thead>
                        <tr class="fw-semibold fs-6 text-muted">
                            ...
                            <th class="border border-1 p-3">Pertanyaan</th>
                            <th class="border border-1 p-3">Nama Data dukung</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($trashedData as $data)
                            <tr>
                                ...
                                <td class="border border-1 text-center">
                                    <a href="{{ route('doc-question.restore', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade text-start"  tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('doc-question.forceDelete', $data->id) }}">
                                            @csrf
                                            @method('delete')
                                ...
                                <td class="text-capitalize border border-1">{{ $data->_question->name }}</td>
