                    ...
                    <tbody>
                        @foreach ($trashedData as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('q-option.restore', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('q-option.forceDelete', $data->id) }}">
                                            @csrf
                                            @method('delete')
                                ...
                                <td class="text-capitalize">{{ $data->_question->name ?? 'pertanyaan belum direstore' }}</td>
