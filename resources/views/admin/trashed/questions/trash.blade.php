                                    ...
                                    @if($data->id_category == null)
                                        <button class="btn btn-warning w-100" disabled>
                                            <div class="d-flex justify-content-center">
                                                <i class="fas fa-exclamation-triangle"></i>&nbsp; Restore Kategori Dulu
                                            </div>
                                        </button>
                                    @else
                                        <a href="{{ route('questions.restore', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                            <div class="d-flex justify-content-center">
                                        ...
                                        <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                            <form action="{{ route('questions.forceDelete', $data->id) }}">
                                                @csrf
                                                @method('delete')
