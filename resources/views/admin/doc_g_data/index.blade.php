...
@section('content')
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body">
            <a href="{{route('doc-g-data.create')}}">
                ...
                <table id="tableSKPD" class="table table-striped table-row-bordered border rounded" style="width:100%">
                    <thead>
                        <tr class="fw-semibold fs-6 text-muted">
                            ...
                            <th class="border border-1">Nama Dokumen</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($doc_data as $data)
                            <tr>
                                ...
                                <td class="border border-1 text-center">
                                    <a href="{{ route('doc-g-data.edit', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('doc-g-data.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
