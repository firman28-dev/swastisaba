    ...
    <div class="card shadow-sm rounded-4">
        <form action="{{ route('category-course.store') }}" method="POST">
            ...
            <div class="card-header">
                <h3 class="card-title">Input Data Kategori Pelatihan</h3>
            </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="form-group w-100">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                required
                                oninvalid="this.setCustomValidity('Nama Pelatihan tidak boleh kosong.')"
                                oninput="this.setCustomValidity('')"
                            >
                            @error('name')
                                <div class="is-invalid">
            ...
            <div class="card-footer">
                ...
                &nbsp;
                <a href="{{route('category-course.index')}}" class="btn btn-sm btn-secondary">
                    Kembali
                </a>
            </div>
