...
@section('content')
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body">
            <a href="{{route('c-kelembagaan.create')}}">
                        ...
                        @foreach ($c_kelembagaan as $data)
                            <tr>
                                ...
                                <td class="border border-1 text-center">
                                    <a href="{{ route('c-kelembagaan.edit', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('c-kelembagaan.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
