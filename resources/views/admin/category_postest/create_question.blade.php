...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{ route('category-postest.storeQuestion') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea id="question" name="question"
                            class="form-control form-control-solid editor" rows="10"></textarea>
                        @error('question')
                            <div class="is-invalid">
                                <span class="text-danger">
                                    {{$message}}
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <textarea id="option_a" name="option_a"
                            class="form-control form-control-solid editor" rows="3"></textarea>
                        @error('option_a')
                            <div class="is-invalid">
                                <span class="text-danger">
                                    {{$message}}
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <textarea id="option_b" name="option_b"
                            class="form-control form-control-solid editor" rows="3"></textarea>
                        @error('option_b')
                            <div class="is-invalid">
                                <span class="text-danger">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <textarea id="option_c" name="option_c"
                            class="form-control form-control-solid editor" rows="3"></textarea>
                        @error('option_c')
                            <div class="is-invalid">
                                <span class="text-danger">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <textarea id="option_d" name="option_d"
                            class="form-control form-control-solid editor" rows="3"></textarea>
                        @error('option_d')
                            <div class="is-invalid">
                                <span class="text-danger">
                    ...
                    <div class="col-lg-12">
                        ...
                        >
                            ...
                            <option value="A" {{ old('opt_correct') == 'A' ? 'selected' : '' }}>A</option>
                            <option value="B" {{ old('opt_correct') == 'B' ? 'selected' : '' }}>B</option>
                            <option value="C" {{ old('opt_correct') == 'C' ? 'selected' : '' }}>C</option>
                            <option value="D" {{ old('opt_correct') == 'D' ? 'selected' : '' }}>D</option>
                        </select>
