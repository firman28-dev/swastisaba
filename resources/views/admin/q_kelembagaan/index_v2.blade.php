...
@section('content')
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body">
            ...
            <p>{{$c_kelembagaan->name}}</p>
            <div class="row">
                <div class="col-lg-6">
                    <a href="{{ route('q-kelembagaan.index')}}">
                    ...
                    &nbsp;
                    <a href="{{route('q-kelembagaan.create', $c_kelembagaan->id)}}">
                        ...
                        @foreach ($q_kelembagaan as $data)
                            <tr>
                                ...
                                <td class="border-1 border text-center">
                                    <a href="{{ route('q-kelembagaan.edit', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade text-start" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('q-kelembagaan.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
                                ...
                                <td class="text-capitalize border-1 border">{{ $data->question }}</td>
                                <td class="text-capitalize border-1 border">{{ $data->opsi }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
