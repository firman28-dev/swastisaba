...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{ route('pendanaan.store') }}" method="POST">
            @csrf
            <div class="card-header">
                <h3 class="card-title">Input Data Pendanaan KabKota</h3>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group w-100">
                            <label for="name" class="form-label">Nama Pendanaan</label>
            ...
            <div class="card-footer">
                ...
                &nbsp;
                <a href="{{route('pendanaan.index')}}" class="btn btn-sm btn-secondary">
                    Kembali
                </a>
            </div>
