        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    &nbsp;
                    <a href="{{route('q-option.create', $question->id)}}">
            ...
            <div class="table-responsive">
                <table id="tableSKPD" class="table table-striped table-row-bordered gy-5 gs-7 border rounded" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($q_option as $data)
                            <tr>
                                <td class="text-center border-1 border">{{ $loop->iteration }}</td>
                                <td class="border-1 border">
                                    <a href="{{ route('q-option.edit', $data->id) }}" class="btn btn-icon btn-primary w-35px h-35px mb-sm-0 mb-3">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="confirmDelete{{ $data->id }}">
                                        <form action="{{ route('q-option.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
