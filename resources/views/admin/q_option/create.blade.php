...
@section('content')
    <div class="card shadow-sm rounded-4">
        <form action="{{ route('q-option.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-header">
                <h3 class="card-title">Input Data Opsi Pertanyaan</h3>
            </div>
            ...
            <div class="card-footer">
                ...
                &nbsp;
                <a href="{{route('showQuestionOpt',$questions->id)}}" class="btn btn-sm btn-secondary">
                    Kembali
                </a>
            </div>
